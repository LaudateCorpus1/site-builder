...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AdminPage = __webpack_require__(3);
	...
	(0, _reactDom.render)(React.createElement(_AdminPage2.default, null), document.getElementById('root-admin'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProjectsContainer = __webpack_require__(5);
	
	var _ProjectsContainer2 = _interopRequireDefault(_ProjectsContainer);
	
	var _ProjectContainer = __webpack_require__(131);
	
	var _ProjectContainer2 = _interopRequireDefault(_ProjectContainer);
	
	var _Tab = __webpack_require__(134);
	
	var _CheckBox = __webpack_require__(135);
	
	var _CheckBox2 = _interopRequireDefault(_CheckBox);
	
	var _Edit = __webpack_require__(136);
	
	var _Edit2 = _interopRequireDefault(_Edit);
	
	var _ProjectThumbnail = __webpack_require__(137);
	
	var _ProjectThumbnail2 = _interopRequireDefault(_ProjectThumbnail);
	
	var _EditArea = __webpack_require__(138);
	
	var _EditArea2 = _interopRequireDefault(_EditArea);
	
	var _DropDown = __webpack_require__(139);
	
	var _DropDown2 = _interopRequireDefault(_DropDown);
	
	var _reactDndHtml5Backend = __webpack_require__(140);
	...
	var AdminPage = function (_React$Component) {
		...
		function AdminPage(props) {
			...
			_this.handleCreateProjectClick = _this.handleCreateProjectClick.bind(_this);
			_this.handleProjectDeleteClick = _this.handleProjectDeleteClick.bind(_this);
			_this.handleImageDeleteClick = _this.handleImageDeleteClick.bind(_this);
			_this.handleProjectImageDrop = _this.handleProjectImageDrop.bind(_this);
			_this.handleDropFile = _this.handleDropFile.bind(_this);
			return _this;
		}
		...
		_createClass(AdminPage, [{
			...
			value: function componentDidMount() {
				...
				this.getProjects().then(function () {
					if (_this2.state.selectedProject == null) {
						var selection = _this2.state.projects.length > 0 ? _this2.state.projects[0].path : null;
						_this2.setState({ selectedProject: selection });
					}
				});
			}
		}, {
			...
			value: function getProjects() {
				...
				return fetch('admin/get_projects.php', {
					...
					return _this3.setState({ projects: data });
			...
			key: 'createProject',
			value: function createProject(path, title) {
				var _this4 = this;
				...
				fetch('admin/create_project.php', {
					...
					var newProjects = update(_this4.state.projects, { $push: [newProject] });
					_this4.setState({ projects: newProjects, selectedProject: path }, _this4.saveProjects);
				}).catch(function (error) {
					return console.log(error);
				});
			}
			...
			value: function handleCreateProjectClick() {
				var title = window.prompt('Enter project title');
				if (title) {
					var _path = title.toLowerCase().replace(/\s+/g, '');
					this.createProject(_path, title);
				}
			}
		}, {
			key: 'handleProjectDeleteClick',
			value: function handleProjectDeleteClick(path) {
				var _this5 = this;
				...
				fetch('admin/delete_project.php', {
					...
					return _this5.setState({ projects: _this5.state.projects.filter(function (p) {
							return p.path != path;
						}) });
				}).catch(function (error) {
					return console.log(error);
			...
			key: 'handleImageDeleteClick',
			value: function handleImageDeleteClick() {
				var _this6 = this;
	
				var path = this.state.selectedProject;
				...
				try {
					var _loop = function _loop() {
						...
						fetch('admin/delete_image.php', {
							...
							var projectIndex = _this6.getSelectedProjectIndex();
							var project = _this6.state.projects[projectIndex];
							var imageIndex = project.images.findIndex(function (i) {
								return i.url == url;
							});
							var projects = update(_this6.state.projects, _defineProperty({}, projectIndex, { images: { $splice: [[imageIndex, 1]] } }));
							_this6.setState({ projects: projects }, _this6.saveProjects);
						}).catch(function (error) {
							return console.log(error);
						});
					};
			...
			key: 'handleProjectImageDrop',
			value: function handleProjectImageDrop(e) {
				var _this7 = this;
	
				var urls = this.state.selectedImages;
				var sourcePath = e.sourcePath;
				var destPath = e.destPath;
				...
				try {
					var _loop2 = function _loop2() {
						...
						fetch('admin/move_image.php', {
							...
							var sourceProjectIndex = _this7.getSelectedProjectIndex();
							var sourceProject = _this7.state.projects[sourceProjectIndex];
	
							var destProjectIndex = _this7.getProjectIndex(destPath);
							var destProject = _this7.state.projects[destProjectIndex];
	
							var imageIndex = sourceProject.images.findIndex(function (i) {
								return i.url == url;
							});
							var image = sourceProject.images[imageIndex];
							var projects = update(_this7.state.projects, _defineProperty({}, sourceProjectIndex, { images: { $splice: [[imageIndex, 1]] } }));
							projects = update(projects, _defineProperty({}, destProjectIndex, { images: { $push: [image] } }));
	
							_this7.setState({ projects: projects }, _this7.saveProjects);
						}).catch(function (error) {
							return console.log(error);
						});
					};
			...
			key: 'resizeDroppedImage',
			value: function resizeDroppedImage(file, action) {
			...
			key: 'uploadImage',
			value: function uploadImage(file, path, url) {
				var _this8 = this;
				...
				var projectIndex = this.getSelectedProjectIndex();
				var newProjects = update(this.state.projects, _defineProperty({}, projectIndex, { images: { $push: [newImage] } }));
				...
				fetch('admin/upload-image.php', {
					...
					var projectIndex = _this8.getSelectedProjectIndex();
					var project = _this8.state.projects[projectIndex];
					var imageIndex = project.images.findIndex(function (i) {
						return i.url == url;
					});
					//console.log('update loaded image:', projectIndex, imageIndex, path, url);
					var newProjects = update(_this8.state.projects, _defineProperty({}, projectIndex, { images: _defineProperty({}, imageIndex, {
							loading: { $set: false },
							fileSize: { $set: file.size },
							date: { $set: formatDate(file.lastModifiedDate) }
						}) }));
					_this8.setState({ projects: newProjects }, _this8.saveProjects);
				}).catch(function (error) {
					...
					var projects = update(_this8.state.projects, _defineProperty({}, projectIndex, { images: { $splice: [[imageIndex, 1]] } }));
					_this8.setState({ projects: projects }, _this8.saveProjects);
				});
			}
		}, {
			key: 'handleDropFile',
			value: function handleDropFile(file) {
				var _this9 = this;
	
				var ACCEPTED_FILE_TYPES = ['image/jpeg', 'image/png', 'image/gif'];
				var resize = false;
				...
				if (file.size > window.FILE_UPLOAD_MAX_SIZE) resize = true;
	
				var url = file.name.toLowerCase();
				var projectIndex = this.getSelectedProjectIndex();
				var project = this.state.projects[projectIndex];
				var imageIndex = project.images.findIndex(function (i) {
					return i.url == url;
				});
				if (imageIndex > -1) {
					if (window.confirm('File ' + url + ' already exists. Overwrite?') == false) return false;else {
						var _projects = update(this.state.projects, _defineProperty({}, projectIndex, { images: { $splice: [[imageIndex, 1]] } }));
						this.setState({ projects: _projects });
					}
				}
	
				window.setTimeout(function () {
					if (resize) _this9.resizeDroppedImage(file, function (blob) {
						return _this9.uploadImage(blob, path, url);
					});else _this9.uploadImage(file, path, url);
				}, 100);
			}
		}, {
			key: 'createProjectThumbnail',
			value: function createProjectThumbnail(path, url, scale, thumbX, thumbY) {
			...
			key: 'getProjectIndex',
			value: function getProjectIndex(path) {
				if (path) {
					return this.state.projects.findIndex(function (p) {
						return p.path == path;
					});
				}
				return -1;
			...
			key: 'getSelectedProjectIndex',
			value: function getSelectedProjectIndex() {
				return this.getProjectIndex(this.state.selectedProject);
			}
		}, {
			key: 'getSelectedProject',
			value: function getSelectedProject() {
				var index = this.getSelectedProjectIndex();
				if (index >= 0) return this.state.projects[index];else return null;
			}
		}, {
			key: 'getSelectedImageIndexes',
			value: function getSelectedImageIndexes() {
				var project = this.getSelectedProject();
				if (!project) return [];
	
				return this.state.selectedImages.map(function (url) {
					return project.images.findIndex(function (i) {
						return i.url == url;
					});
				});
			}
			...
			value: function getSelectedImages() {
				...
				return this.state.selectedImages.map(function (url) {
					return project.images.find(function (i) {
						return i.url == url;
					});
				});
			}
			...
			value: function getProjectMenu() {
				...
				if (project != null) {
					var _ret3 = function () {
						...
						var thumbHeight = void 0;
	
						var thumbUrl = project.thumbUrl;
						var thumbIndex = project.images.findIndex(function (i) {
							return i.url == thumbUrl;
						});
						if (thumbIndex > -1) {
							...
							v: React.createElement(
								...
								React.createElement(_Edit2.default, {
									...
									onChange: function onChange(v) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, { title: { $set: v } }));
										_this10.setState({ projects: projects }, _this10.saveProjects);
									}
								}),
								React.createElement(_EditArea2.default, {
									label: 'Description',
									value: project.description,
									onChange: function onChange(v) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, { description: { $set: v } }));
										_this10.setState({ projects: projects }, _this10.saveProjects);
									}
								}),
								React.createElement(_Edit2.default, {
									...
									onChange: function onChange(v) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, { tags: { $set: v } }));
										_this10.setState({ projects: projects }, _this10.saveProjects);
									}
								}),
								React.createElement(_CheckBox2.default, {
									...
									onChange: function onChange(v) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, { visible: { $set: v } }));
										_this10.setState({ projects: projects }, _this10.saveProjects);
									}
								}),
								React.createElement(_DropDown2.default, {
									...
									onChange: function onChange(v) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, { sortBy: { $set: v } }));
										_this10.setState({ projects: projects }, _this10.saveProjects);
									},
									values: [['Manual', 'MANUAL'], ['File Name', 'FILENAME'], ['File Type', 'TYPE'], ['Title', 'TITLE'], ['Dimensions', 'DIMENSIONS'], ['Date', 'DATE']]
								}),
								React.createElement(_DropDown2.default, {
									label: '',
									...
									onChange: function onChange(v) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, { sortOrder: { $set: v } }));
										_this10.setState({ projects: projects }, _this10.saveProjects);
									},
								...
								React.createElement(_ProjectThumbnail2.default, {
									...
									onImageDrop: function onImageDrop(e) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, { thumbUrl: { $set: e.url } }));
										_this10.setState({ projects: projects }, _this10.saveProjects);
									},
									onThumbTransform: function onThumbTransform(e) {
										var projectIndex = _this10.getSelectedProjectIndex();
										var projects = update(_this10.state.projects, _defineProperty({}, projectIndex, {
											thumbX: { $set: e.x },
											thumbY: { $set: e.y },
											thumbScale: { $set: e.scale }
										}));
										_this10.setState({ projects: projects }, _this10.saveProjects);
										_this10.createProjectThumbnail(_this10.state.selectedProject, _this10.state.projects[projectIndex].thumbUrl, e.scale, e.x, e.y);
									}
			...
			key: 'getImageMenu',
			value: function getImageMenu() {
				var _this11 = this;
	
				var projectIndex = this.getSelectedProjectIndex();
				var project = this.getSelectedProject();
	
				var imageIndexes = this.getSelectedImageIndexes();
				...
				if (image) return React.createElement(
					_Tab.TabPanel,
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'td',
								null,
								image.width ? image.width + 'px' : 'n/a'
							)
						),
						React.createElement(
							'tr',
							...
							React.createElement(
								'td',
								null,
								image.height ? image.height + 'px' : 'n/a'
							)
						),
						React.createElement(
							'tr',
					...
					React.createElement(_Edit2.default, {
						...
						onChange: function onChange(v) {
							...
							var newProjects = update(_this11.state.projects, _defineProperty({}, projectIndex, { images: _defineProperty({}, imageIndex, { title: { $set: v } }) }));
							_this11.setState({ projects: newProjects }, _this11.saveProjects);
						}
					}),
					React.createElement(_CheckBox2.default, {
						label: 'Visible',
						...
						onChange: function onChange(v) {
							var newProjects = update(_this11.state.projects, _defineProperty({}, projectIndex, { images: _defineProperty({}, imageIndex, { visible: { $set: v } }) }));
							_this11.setState({ projects: newProjects }, _this11.saveProjects);
						}
					})
				);else return React.createElement(
			...
			key: 'getStatusBar',
			value: function getStatusBar() {
				var project = this.getSelectedProject();
				var imageCount = project ? project.images.length : 0;
				var totalImageCount = this.state.projects.reduce(function (p, c) {
					return p + c.images.length;
				}, 0);
				var projectSize = project ? project.dirSize : 0;
				var totalSize = this.state.projects.reduce(function (p, c) {
					return p + c.dirSize;
				}, 0);
				return React.createElement(
					'div',
					...
					React.createElement(
						'span',
						{ className: 'right' },
						React.createElement('i', { onClick: logout, className: 'fa fa-sign-out', 'aria-hidden': 'true' })
					)
				);
			}
		}, {
			...
			value: function render() {
				...
				var project = this.getSelectedProject();
				var images = project ? project.images : [];
	
				return React.createElement(
					_DropContainer2.default,
					{ onDropFile: this.handleDropFile },
					React.createElement(_ProjectsContainer2.default, {
						projects: this.state.projects,
						selection: this.state.selectedProject,
						onProjectClick: function onProjectClick(path) {
							return _this12.setState({ selectedProject: path });
						},
					...
					React.createElement(_ProjectContainer2.default, {
						project: project,
						selection: this.state.selectedImages,
						onImageClick: function onImageClick(url, e) {
							var selection = [];
							if (url) {
								selection = _this12.state.selectedImages;
	
								if (e.shiftKey) {} else if (e.ctrlKey || e.metaKey) {
									if (selection.includes(url)) {
										selection = selection.filter(function (u) {
											return u != url;
										});
									} else {
							...
							_this12.setState({ selectedImages: selection });
						},
	...
	exports.default = (0, _reactDnd.DragDropContext)(_reactDndHtml5Backend2.default)(AdminPage);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DropContainer = function (_React$Component) {
		...
		function DropContainer(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DropContainer).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProjectItem = __webpack_require__(6);
	...
	var IconButton = function IconButton(_ref) {
		...
		return React.createElement(
			...
			React.createElement('i', { className: 'fa ' + icon, onClick: onClick, 'aria-hidden': 'true' })
		);
	};
	...
	var ProjectsContainer = function (_React$Component) {
		...
		function ProjectsContainer() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ProjectsContainer).apply(this, arguments));
		}
		...
		_createClass(ProjectsContainer, [{
			...
			value: function render() {
				...
				var items = this.props.projects.map(function (p) {
					return React.createElement(_ProjectItem2.default, {
						key: p.path,
						path: p.path,
						title: p.title || p.path,
						visible: p.visible,
						locked: p.locked,
						selected: p.path == _this2.props.selection,
						onClick: function onClick(e) {
							e.stopPropagation();
							_this2.props.onProjectClick(p.path);
						},
						onDeleteIconClick: function onDeleteIconClick(e) {
							e.stopPropagation();
							_this2.props.onProjectDeleteClick(p.path);
						},
						onImageDrop: function onImageDrop(e) {
							e.sourcePath = e.path;
							e.destPath = p.path;
							_this2.props.onProjectImageDrop(e);
						}
					});
				});
				...
				return React.createElement(
					...
					'Projects ',
					React.createElement(IconButton, { icon: 'fa-plus', onClick: this.props.onCreateProjectClick }),
					items
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectItem = function ProjectItem(_ref2) {
		var path = _ref2.path;
		...
		var onImageDrop = _ref2.onImageDrop;
		var connectDropTarget = _ref2.connectDropTarget;
		var isOver = _ref2.isOver;
		var canDrop = _ref2.canDrop;
	
	
		var className = "project-item" + (selected ? ' selected' : '');
		if (isOver && canDrop) className += ' over';
	
		var _title = title;
		if (visible == false) className += ' hidden';
	
		var _lock = React.createElement('i', { className: 'fa fa-folder', 'aria-hidden': 'true' });
		if (selected) _lock = React.createElement('i', { className: 'fa fa-folder-open', 'aria-hidden': 'true' });
	
		var _delete = void 0;
		if (locked) {
			_lock = React.createElement('i', { className: 'fa fa-inbox', 'aria-hidden': 'true' });
		} else _delete = React.createElement(DeleteIcon, { onClick: onDeleteIconClick });
		_title = ' ' + title;
	...
	exports.default = (0, _reactDnd.DropTarget)('imageItem', projectItemTarget, collect)(ProjectItem);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DragDropContext = __webpack_require__(8);
	
	exports.DragDropContext = _interopRequire(_DragDropContext);
	
	var _DragLayer = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dndCore = __webpack_require__(9);
	
	var _invariant = __webpack_require__(23);
	
	var _invariant2 = _interopRequireDefault(_invariant);
	
	var _utilsCheckDecoratorArguments = __webpack_require__(107);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DragDropManager = __webpack_require__(10);
	...
	var _backendsCreateTestBackend = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxLibCreateStore = __webpack_require__(11);
	...
	var _DragDropMonitor = __webpack_require__(99);
	
	var _DragDropMonitor2 = _interopRequireDefault(_DragDropMonitor);
	
	var _HandlerRegistry = __webpack_require__(100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stateId = __webpack_require__(98);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashXor = __webpack_require__(86);
	
	var _lodashXor2 = _interopRequireDefault(_lodashXor);
	
	var _lodashIntersection = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(87),
	    baseXor = __webpack_require__(88),
	    isArrayLikeObject = __webpack_require__(73),
	    rest = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayPush = __webpack_require__(89),
	    baseDifference = __webpack_require__(29),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetNextUniqueId = __webpack_require__(101);
	
	var _utilsGetNextUniqueId2 = _interopRequireDefault(_utilsGetNextUniqueId);
	
	var _actionsRegistry = __webpack_require__(27);
	
	var _asap = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rawAsap = __webpack_require__(103);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashNoop = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(109);
	
	var _utilsShallowEqual2 = _interopRequireDefault(_utilsShallowEqual);
	
	var _utilsShallowEqualScalar = __webpack_require__(110);
	
	var _utilsShallowEqualScalar2 = _interopRequireDefault(_utilsShallowEqualScalar);
	
	var _lodashIsPlainObject = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _decorateHandler = __webpack_require__(112);
	
	var _decorateHandler2 = _interopRequireDefault(_decorateHandler);
	
	var _registerSource = __webpack_require__(118);
	
	var _registerSource2 = _interopRequireDefault(_registerSource);
	
	var _createSourceFactory = __webpack_require__(119);
	
	var _createSourceFactory2 = _interopRequireDefault(_createSourceFactory);
	
	var _createSourceMonitor = __webpack_require__(120);
	
	var _createSourceMonitor2 = _interopRequireDefault(_createSourceMonitor);
	
	var _createSourceConnector = __webpack_require__(121);
	
	var _createSourceConnector2 = _interopRequireDefault(_createSourceConnector);
	
	var _utilsIsValidType = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _disposables = __webpack_require__(113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isDisposable2 = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isDisposable = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _areOptionsEqual = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCloneWithRef = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _registerTarget = __webpack_require__(127);
	
	var _registerTarget2 = _interopRequireDefault(_registerTarget);
	
	var _createTargetFactory = __webpack_require__(128);
	
	var _createTargetFactory2 = _interopRequireDefault(_createTargetFactory);
	
	var _createTargetMonitor = __webpack_require__(129);
	
	var _createTargetMonitor2 = _interopRequireDefault(_createTargetMonitor);
	
	var _createTargetConnector = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImageItem = __webpack_require__(132);
	...
	var NewProjectItem = function NewProjectItem(_ref) {
		var onClick = _ref.onClick;
		return React.createElement(
			'div',
			{ className: 'new-project', onClick: onClick },
			React.createElement(
				'div',
				null,
				React.createElement('i', { className: 'fa fa-plus fa-3x', 'aria-hidden': 'true' }),
	...
	var ProjectContainer = function (_React$Component) {
		...
		function ProjectContainer() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ProjectContainer).apply(this, arguments));
		}
	
		_createClass(ProjectContainer, [{
			key: 'getSortedImages',
			value: function getSortedImages() {
				if (this.props.project) {
					var images = this.props.project.images.slice(0);
					switch (this.props.project.sortBy) {
						...
						case 'TYPE':
							images.sort(function (a, b) {
								return getFilenameExtension(a.url) > getFilenameExtension(b.url) ? 1 : -1;
							});
							break;
						case 'TITLE':
							images.sort(function (a, b) {
					...
					if (this.props.project.sortOrder == 'DESCENDING') images.reverse();
					return images;
				} else return [];
			}
		}, {
			...
			value: function render() {
				...
				var sortedImages = this.getSortedImages();
				var items = sortedImages.map(function (p) {
					return React.createElement(_ImageItem2.default, {
						key: p.url,
						path: _this2.props.project.path,
						url: p.url,
						fullUrl: 'content/projects/' + _this2.props.project.path + '/thumb/' + p.url,
						title: p.title || p.url,
						visible: p.visible,
						selected: _this2.props.selection.includes(p.url),
						loading: p.loading,
						onClick: function onClick(e) {
							e.stopPropagation();
							_this2.props.onImageClick(p.url, e);
						},
						onDeleteIconClick: function onDeleteIconClick(e) {
							e.stopPropagation();
							_this2.props.onImageDeleteClick(p.url);
						}
					});
				});
				...
				return React.createElement(
					...
					{ className: 'project-container',
						onClick: function onClick(e) {
							e.stopPropagation();
							_this2.props.onImageClick(null, e);
						}
					},
					items
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LazyImage = __webpack_require__(133);
	...
	var ImageItem = function (_React$Component) {
		...
		_createClass(ImageItem, [{
			...
			value: function render() {
				...
				var onDeleteIconClick = _props.onDeleteIconClick;
				var connectDragSource = _props.connectDragSource;
				var isDragging = _props.isDragging;
	
				var deleteIcon = void 0;
	
				deleteIcon = React.createElement(DeleteIcon, { onClick: onDeleteIconClick });
	
				var className = "image-item" + (selected ? ' selected' : '');
				...
				var loadingIcon = React.createElement(
					'div',
					{ className: 'loading' },
					React.createElement('i', { className: 'fa fa-circle-o-notch fa-3x fa-spin', 'aria-hidden': 'true' })
				);
				...
				if (loading) return React.createElement(
					...
					loadingIcon
				);else return connectDragSource(React.createElement(
					'div',
					{
						className: className,
						onClick: onClick
					},
					React.createElement(_LazyImage2.default, { src: fullUrl, alt: url }),
					deleteIcon
				));
			}
		}]);
	...
	exports.default = (0, _reactDnd.DragSource)('imageItem', imageItemSource, collect)(ImageItem);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Tabs = exports.TabPanel = undefined;
	...
	var TabPanel = exports.TabPanel = function (_React$Component3) {
		_inherits(TabPanel, _React$Component3);
	
		function TabPanel() {
			_classCallCheck(this, TabPanel);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(TabPanel).apply(this, arguments));
		}
	
		_createClass(TabPanel, [{
			key: 'render',
			value: function render() {
				var className = 'tab-panel';
				if (this.props.active) className += ' active';
	...
	var Tabs = exports.Tabs = function (_React$Component4) {
		...
		function Tabs(props) {
			...
			_this4.state = {
				activeTab: _this4.props.activeTab
			};
			...
			value: function getTabs() {
				...
				return React.Children.map(this.props.children, function (child) {
					return React.createElement(Tab, {
						...
						active: child.key == _this5.state.activeTab,
						onClick: function onClick() {
							_this5.handleTabClick(child.key);
						}
					});
				});
			}
			...
			value: function getTabPanels() {
				...
				return React.Children.map(this.props.children, function (child) {
					return React.createElement(TabPanel, {
						key: child.key,
						label: child.props.label,
						active: child.key == _this6.state.activeTab,
		...
		return React.createElement(
			...
			React.createElement("input", {
				...
				onChange: function onChange() {
					return _onChange(input.checked);
				}
			}),
			React.createElement(
				"label",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectThumbnail = function (_React$Component) {
		_inherits(ProjectThumbnail, _React$Component);
	
		function ProjectThumbnail(props) {
			_classCallCheck(this, ProjectThumbnail);
	
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ProjectThumbnail).call(this, props));
	
			_this._originX = 0;
			_this._originY = 0;
			_this.state = { x: 0, y: 0, scale: 1 };
		...
		_createClass(ProjectThumbnail, [{
			...
			value: function validateTransform(x, y, scale, width, height) {
				var ratio = height / width;
	
				scale = Math.min(10, Math.max(scale, Math.max(1, 1 / ratio)));
	
				var minX = 1 - scale;
				var minY = 1 - scale * ratio;
			...
			value: function componentWillReceiveProps(nextProps) {
				...
				this.setState(this.validateTransform(nextProps.x, nextProps.y, nextProps.scale, nextProps.width, nextProps.height));
			}
		}, {
			key: 'handleMouseDown',
			...
			value: function handleMouseMove(e) {
				if (e.buttons == 1 && this._oldState) {
					var r = this._main.getBoundingClientRect();
					var w = r.right - r.left;
					var h = r.bottom - r.top;
	
					var _scale = this.state.scale;
					var _x = this._oldState.x;
					var _y = this._oldState.y;
	
					if (e.shiftKey) {
						_scale = this._oldState.scale - (e.clientY - this._originY) / 100;
						_x = this._oldState.x - (_scale - this._oldState.scale) / 2;
						_y = this._oldState.y - (_scale - this._oldState.scale) / 2;
					} else {
						_x = this._oldState.x + (e.clientX - this._originX) / w;
						_y = this._oldState.y + (e.clientY - this._originY) / h;
					}
	
					this.setState(this.validateTransform(_x, _y, _scale, this.props.width, this.props.height));
				}
				e.preventDefault();
			}
		}, {
			...
			value: function render() {
				...
				var onImageDrop = _props.onImageDrop;
				var connectDropTarget = _props.connectDropTarget;
				var isOver = _props.isOver;
				var canDrop = _props.canDrop;
	
	
				var className = "project-thumbnail";
				if (isOver && canDrop) className += ' over';
				...
				if (!fullUrl || !width || !height) {
					return connectDropTarget(React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'empty' },
							'Drag image here to set project thumbnail.'
						)
					));
				}
				...
				return connectDropTarget(React.createElement(
					...
					React.createElement(DeleteIcon, {
						onClick: function onClick() {
							return _this2.props.onImageDrop({
								path: null, url: null
							});
						}
					})
	...
	exports.default = (0, _reactDnd.DropTarget)('imageItem', projectThumbnailTarget, collect)(ProjectThumbnail);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashDefaults = __webpack_require__(142);
	...
	var _EnterLeaveCounter = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apply = __webpack_require__(79),
	    assignInDefaults = __webpack_require__(143),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isIterateeCall = __webpack_require__(148),
	    rest = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashUnion = __webpack_require__(161);
